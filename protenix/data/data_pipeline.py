...
from protenix.data.parser import DistillationMMCIFParser, MMCIFParser, ATLASMMCIFParser, OpenmmMMCIFParser
    ...
    def get_data_from_mmcif(
        ...
        **kwargs,
        ...
        try:
            ...
            elif dataset in ("OpenMM", "Openmm"):
                parser = OpenmmMMCIFParser(mmcif_file=mmcif)
                bioassembly_dict = parser.get_structure_dict(**kwargs)
            else:
